...
The examples include applications using `core.async` with https://github.com/xadecimal/async-style[`async-style`] and `CompletableFuture` with https://github.com/mpenet/auspex/[`auspex`].
