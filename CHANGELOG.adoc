...
- Bump deps
* [MAINT] OpenTelemetry `1.40.0`, semconv `1.26.0-alpha`, instrumentation `2.6.0-alpha`
* [ADD] `MemoryMode` option for programmatically configured OTLP exporters.
...
* [ADD] Add functions and middleware to add `http.route` instrumentation data to metrics and traces.
