...
- [NEW] Module `clj-otel-instrumentation-runtime-telemetry`, replaces deprecated modules `clj-otel-instrumentation-runtime-telemetry-java8` and `clj-otel-instrumentation-runtime-telemetry-java17`
...
- Bump deps
* [MAINT] OpenTelemetry `1.60.1`, semconv `1.40.0`, instrumentation `2.26.1`
