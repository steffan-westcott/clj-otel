...
{;; ...
 ...
 :aliases {
   :otel {:jvm-opts ["-Dotel.resource.attributes=service.name=my-app"
                     ...
                     "-Dotel.logs.exporter=none"
                     "-Dotel.exporter.otlp.traces.protocol=grpc"]
          :extra-deps {io.opentelemetry/opentelemetry-exporter-otlp               {:mvn/version "1.40.0"}
                       io.opentelemetry.instrumentation/opentelemetry-resources   {:mvn/version "2.6.0-alpha"}
                       io.grpc/grpc-netty-shaded                                  {:mvn/version "1.65.1"}
                       io.grpc/grpc-protobuf                                      {:mvn/version "1.65.1"}
                       io.grpc/grpc-stub                                          {:mvn/version "1.65.1"}}}}}
----
