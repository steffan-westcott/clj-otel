...
{;; ...
 ...
 :aliases {
   :otel {:jvm-opts ["-Dotel.resource.attributes=service.name=my-app"
                     ...
                     "-Dotel.logs.exporter=none"
                     "-Dotel.exporter.otlp.traces.protocol=grpc"]
          :extra-deps {io.opentelemetry/opentelemetry-exporter-otlp               {:mvn/version "1.43.0"}
                       io.opentelemetry.instrumentation/opentelemetry-resources   {:mvn/version "2.9.0-alpha"}
