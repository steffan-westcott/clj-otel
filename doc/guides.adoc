...
----
{;; ...
 :deps {com.github.steffan-westcott/clj-otel-api {:mvn/version "0.1.3"}}}
----
...
{;; ...
 :aliases {
   :otel {:jvm-opts ["-Dotel.resource.attributes=service.name=my-app"
                     ...
                     "-Dotel.metrics.exporter=none"
                     "-Dotel.exporter.otlp.traces.protocol=grpc"]
          :extra-deps {io.opentelemetry/opentelemetry-sdk-extension-autoconfigure {:mvn/version "1.15.0-alpha"}
                       io.opentelemetry/opentelemetry-sdk-extension-resources     {:mvn/version "1.15.0"}
                       io.opentelemetry/opentelemetry-exporter-otlp               {:mvn/version "1.15.0"}
                       io.grpc/grpc-netty-shaded                                  {:mvn/version "1.47.0"}
                       io.grpc/grpc-protobuf                                      {:mvn/version "1.47.0"}
                       io.grpc/grpc-stub                                          {:mvn/version "1.47.0"}}}}}
----
...
----
{;; ...
 :deps {com.github.steffan-westcott/clj-otel-sdk                      {:mvn/version "0.1.3"}
        com.github.steffan-westcott/clj-otel-sdk-extension-resources  {:mvn/version "0.1.3"}
        com.github.steffan-westcott/clj-otel-exporter-otlp-grpc-trace {:mvn/version "0.1.3"}
        io.grpc/grpc-netty-shaded                                     {:mvn/version "1.47.0"}
        io.grpc/grpc-protobuf                                         {:mvn/version "1.47.0"}
        io.grpc/grpc-stub                                             {:mvn/version "1.47.0"}}}
----
