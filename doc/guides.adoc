...
** _Required:_ `io.opentelemetry/opentelemetry-exporter-???` for any required xref:reference.adoc#_exporter_libraries_and_modules[exporters]
...
** _Required:_ `com.github.steffan-westcott/clj-otel-exporter-???` for xref:reference.adoc#_exporter_libraries_and_modules[Clojure wrapped versions of any required exporters]
