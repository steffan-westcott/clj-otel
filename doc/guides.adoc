...
----
{;; ...
 :deps {com.github.steffan-westcott/clj-otel-instrumentation-runtime-telemetry-java8 {:mvn/version "0.2.3"}}}
----
...
----
{;; ...
 :deps {com.github.steffan-westcott/clj-otel-instrumentation-runtime-telemetry-java17 {:mvn/version "0.2.3"}}}
----
...
----
{;; ...
 :deps {com.github.steffan-westcott/clj-otel-sdk-extension-autoconfigure {:mvn/version "1.27.0-alpha"}}
 :aliases {
   :otel {:jvm-opts ["-Dotel.resource.attributes=service.name=my-app"
                     ...
                     "-Dotel.logs.exporter=none"
                     "-Dotel.exporter.otlp.traces.protocol=grpc"]
          :extra-deps {io.opentelemetry/opentelemetry-exporter-otlp               {:mvn/version "1.27.0"}
                       io.opentelemetry.instrumentation/opentelemetry-resources   {:mvn/version "1.27.0-alpha"}
                       io.grpc/grpc-netty-shaded                                  {:mvn/version "1.56.0"}
                       io.grpc/grpc-protobuf                                      {:mvn/version "1.56.0"}
                       io.grpc/grpc-stub                                          {:mvn/version "1.56.0"}}}}}
----
...
----
{;; ...
 :deps {com.github.steffan-westcott/clj-otel-exporter-otlp            {:mvn/version "0.2.3"}
        com.github.steffan-westcott/clj-otel-sdk-extension-resources  {:mvn/version "0.2.3"}
        com.github.steffan-westcott/clj-otel-sdk                      {:mvn/version "0.2.3"}
        io.grpc/grpc-netty-shaded                                     {:mvn/version "1.56.0"}
        io.grpc/grpc-protobuf                                         {:mvn/version "1.56.0"}
        io.grpc/grpc-stub                                             {:mvn/version "1.56.0"}}}
----
