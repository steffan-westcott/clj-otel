...
----
{;; ...
 :deps {com.github.steffan-westcott/clj-otel-sdk                      {:mvn/version "0.1.4"}
        com.github.steffan-westcott/clj-otel-sdk-extension-resources  {:mvn/version "0.1.4"}
        com.github.steffan-westcott/clj-otel-exporter-otlp            {:mvn/version "0.1.4"}
        io.grpc/grpc-netty-shaded                                     {:mvn/version "1.47.0"}
        io.grpc/grpc-protobuf                                         {:mvn/version "1.47.0"}
        io.grpc/grpc-stub                                             {:mvn/version "1.47.0"}}}
----
