...
----
{;; ...
 :deps {com.github.steffan-westcott/clj-otel-instrumentation-runtime-metrics {:mvn/version "0.2.2"}}}
----
 ...
 :aliases {
   :otel {:jvm-opts ["-Dotel.resource.attributes=service.name=my-app"
          ...
          :extra-deps {io.opentelemetry/opentelemetry-sdk-extension-autoconfigure {:mvn/version "1.27.0-alpha"}
                       ...
                       io.grpc/grpc-netty-shaded                                  {:mvn/version "1.55.1"}
                       io.grpc/grpc-protobuf                                      {:mvn/version "1.55.1"}
                       io.grpc/grpc-stub                                          {:mvn/version "1.55.1"}}}}}
----
...
----
{;; ...
 :deps {com.github.steffan-westcott/clj-otel-exporter-otlp            {:mvn/version "0.2.2"}
        com.github.steffan-westcott/clj-otel-sdk-extension-resources  {:mvn/version "0.2.2"}
