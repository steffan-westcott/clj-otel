...
* Use https://cljdoc.org/d/com.github.steffan-westcott/clj-otel-api/CURRENT/api/steffan-westcott.otel.api.trace.span#with-span![`steffan-westcott.otel.api.trace.span/with-span!`] to wrap a body of forms in a span, where the xref:concepts.adoc#_current_context[current context] is used to keep track of (potentially nested) spans:
+
[source,clojure]
----
(defn get-nums [args]
...
* Alternatively, use https://cljdoc.org/d/com.github.steffan-westcott/clj-otel-api/CURRENT/api/steffan-westcott.otel.api.trace.span#add-span-data![`steffan-westcott.otel.api.trace.span/add-span-data!`] to add attributes to an existing span.
+
...
* Use https://cljdoc.org/d/com.github.steffan-westcott/clj-otel-api/CURRENT/api/steffan-westcott.otel.api.trace.span#add-span-data![`steffan-westcott.otel.api.trace.span/add-span-data!`] to add an event to an existing span.
...
* Use https://cljdoc.org/d/com.github.steffan-westcott/clj-otel-api/CURRENT/api/steffan-westcott.otel.context#->headers[`steffan-westcott.otel.context/\->headers`] to get headers to merge (inject) in the HTTP request to be issued.
+
...
** _Optional:_ `io.grpc/grpc-netty-shaded`, `io.grpc/grpc-protobuf` and `io.grpc/grpc-stub` to use Netty for gRPC transport rather than the default OkHttp (see example below).
This is not needed if gRPC is not used by any exporters or the application.
* On application start, use https://cljdoc.org/d/com.github.steffan-westcott/clj-otel-sdk/CURRENT/api/steffan-westcott.otel.sdk.otel-sdk#init-otel-sdk![`steffan-westcott.otel.sdk.otel-sdk/init-otel-sdk!`] to configure and set an OpenTelemetry SDK instance as the global OpenTelemetry instance.
* On application end, use https://cljdoc.org/d/com.github.steffan-westcott/clj-otel-sdk/CURRENT/api/steffan-westcott.otel.sdk.otel-sdk#close-otel-sdk![`steffan-westcott.otel.sdk.otel-sdk/close-otel-sdk!`] to close down activities of the SDK instance.
...
To configure the SDK on start and close down on end, the application could have functions like the following:
...
This example configuration has a traces pipeline where:
