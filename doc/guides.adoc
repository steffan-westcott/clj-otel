...
----
{;; ...
 :deps {com.github.steffan-westcott/clj-otel-sdk-extension-autoconfigure {:mvn/version "0.2.3"}}
 :aliases {
   :otel {:jvm-opts ["-Dotel.resource.attributes=service.name=my-app"
                     ...
                     "-Dotel.logs.exporter=none"
                     "-Dotel.exporter.otlp.traces.protocol=grpc"]
          :extra-deps {io.opentelemetry/opentelemetry-exporter-otlp               {:mvn/version "1.29.0"}
                       io.opentelemetry.instrumentation/opentelemetry-resources   {:mvn/version "1.29.0-alpha"}
