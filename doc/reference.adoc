...
image:https://img.shields.io/badge/clojars-0.2.10-orange?logo=clojure&logoColor=white[Clojars,link=https://clojars.org/com.github.steffan-westcott/clj-otel-instrumentation-runtime-telemetry/versions/0.2.10]
image:https://img.shields.io/badge/cljdoc-0.2.10-blue[cljdoc,link=https://cljdoc.org/d/com.github.steffan-westcott/clj-otel-instrumentation-runtime-telemetry/0.2.10]

Provide access to OpenTelemetry instrumentation of the JVM runtime.
...
WARNING: This module is deprecated, use `clj-otel-instrumentation-runtime-telemetry` instead
...
These modules adapt third-party libraries for use with `clj-otel`.

=== `clj-otel-adapter-log4j`

OpenTelemetry appender and context data provider for Log4j.
Has the same configuration and functionality provided by OpenTelemetry Java instrumentation versions, but is bound context aware.

=== `clj-otel-adapter-logback`

Appenders providing log events and MDC for Logback.
Has the same configuration and functionality provided by OpenTelemetry Java instrumentation versions, but is bound context aware.
