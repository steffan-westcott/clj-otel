...
----
+
Simulate a downstream 5xx internal server error by including the word type `fault` in the request:
+
[source,bash]
[.small]
----
...
----
+
Simulate a downstream 4xx user request error by including an unknown word type in the request:
+
[source,bash]
[.small]
----
...
----
+
Simulate a downstream 5xx internal server error by using odd numbers that add to 13:
+
[source,bash]
[.small]
----
...
----
+
Simulate a downstream 4xx user request error by giving first number 0:
+
[source,bash]
[.small]
----
